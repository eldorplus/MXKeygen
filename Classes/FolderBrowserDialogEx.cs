...
/*
    ...
    Replacement for the builtin System.Windows.Forms.FolderBrowserDialog class.

    Features:
        - Edit Box
        - Display full path to destination
*/
...
namespace MobaXtermKG.Utils
{

    /*
        Folder Browser Dialog Ex
    */

    public class FolderBrowserDialogEx : System.Windows.Forms.CommonDialog
    {
        private static readonly int MAX_PATH_CHARS = 260;
        ...
        private bool _bShowNewFolderButton;
        ...
        private bool _bExcludeNetFoldersBelowDomainLevel;
                ...
                case BrowseForFolderMessages.BFFM_SELCHANGED:
                    ...
                    if ( pidl != IntPtr.Zero )
                    {
                            ...
                            ( ( _uiFlags & BrowseFlags.BIF_BROWSEFORCOMPUTER ) == BrowseFlags.BIF_BROWSEFORCOMPUTER ) )
                        {
                            ...
                            /*
                                browsing for a printer or computer, enable the OK button unconditionally.
                            */
                        ...
                        {
                            IntPtr pszPath          = Marshal.AllocHGlobal( MAX_PATH_CHARS * Marshal.SystemDefaultCharSize );
        ...
        */
        ...
        public override void Reset( )
        {
            ...
            this._bShowNewFolderButton      = true;
            this._showEditBox               = true;
            this._newStyle                  = true;
            this._bExcludeNetFoldersBelowDomainLevel = false;
        ...
        */
        ...
        protected override bool RunDialog( IntPtr hWndOwner )
        {
            ...
            try
            {
                ...
                hglobal = Marshal.AllocHGlobal( MAX_PATH_CHARS * Marshal.SystemDefaultCharSize );
                pszPath = Marshal.AllocHGlobal( MAX_PATH_CHARS * Marshal.SystemDefaultCharSize );
        ...
        /*
            File Dialog > Description
                ...
                Description appears near the top of the dialog box, providing direction to the user.
        */
        ...
        */
        ...
        /*
            File Dialog > Show "New Folder" button
        ...
        */
        ...
        {
            get { return this._bShowNewFolderButton; }
            set { this._bShowNewFolderButton = value; }
        }

        /*
            File Dialog > Show "Edit" Box
        ...
        */
        ...
        /*
            Exclude Network Folder Below Domain Level
        */

        public bool ExcludeNetFoldersBelowDomainLevel
        {
            get { return _bExcludeNetFoldersBelowDomainLevel; }
            set { _bExcludeNetFoldersBelowDomainLevel = value; }
        }

        /*
            File Dialog > Show Full Path in Edit Box
