...
namespace MobaXtermKG
{
    partial class FormAbout
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txt_Dev_GPG_KeyID = new MobaXtermKG.ZWTextBox();
            this.txt_Dev_PIV_Thumbprint = new MobaXtermKG.ZWTextBox();
            this.txt_Terms = new MobaXtermKG.ZWTextBox();
            ...
            this.lbl_Version.Text = "v1.2.0.0 by ZW";
        ...
        private ZWTextBox txt_Terms;
        private ZWTextBox txt_Dev_PIV_Thumbprint;
        private Label lbl_Dev_PIV_Thumbprint;
        private Label lbl_Dev_GPG_KeyID;
        private ZWTextBox txt_Dev_GPG_KeyID;
