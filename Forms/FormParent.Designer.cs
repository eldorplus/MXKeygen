...
namespace MobaXtermKG
{
    partial class FormParent
    {
        ...
        */
        ...
        private void InitializeComponent()
        {
            ...
            this.aetherxRTextBox1 = new MobaXtermKG.ZWRTextBox();
            this.txt_LicenseKey = new MobaXtermKG.ZWTextBox();
            this.txt_Version = new MobaXtermKG.ZWTextBox();
            this.txt_Users = new MobaXtermKG.ZWTextBox();
            this.txt_Name = new MobaXtermKG.ZWTextBox();
            this.rtxt_Desc = new MobaXtermKG.ZWRTextBox();
            this.btn_OpenFolder = new MobaXtermKG.ZWButton();
            this.btn_Generate = new MobaXtermKG.ZWButton();
    ...
    "de the install path of MobaXterm.";
        ...
        private ZWButton btn_Generate;
        private ZWButton btn_OpenFolder;
        private ZWRTextBox rtxt_Desc;
        private ZWTextBox txt_Name;
        private ZWTextBox txt_Users;
        private ZWTextBox txt_Version;
        private ZWTextBox txt_LicenseKey;
        private ZWRTextBox aetherxRTextBox1;
