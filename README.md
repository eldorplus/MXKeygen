...
![Version](https://img.shields.io/github/v/tag/zwpseudo/MobaXtermKeygen?logo=GitHub&label=version&color=ba5225) ![Downloads](https://img.shields.io/github/downloads/zwpseudo/MobaXtermKeygen/total) ![Repo Size](https://img.shields.io/github/repo-size/zwpseudo/MobaXtermKeygen?label=size&color=59702a) ![Last Commit)](https://img.shields.io/github/last-commit/zwpseudo/MobaXtermKeygen?color=b43bcc)
...
If you wish to simply use this utility, head over to the [Releases](https://github.com/zwpseudo/MobaXtermKeygen/releases) section and download the latest binary as a `zip` or `rar`. The download is a single `exe`.
